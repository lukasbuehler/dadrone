...
app.use(express.static(__dirname + "/view")); // Uses the HTML files from the page directory

app.get("/", function (req, res) {
  res.sendFile(path.join(__dirname, "view", "index.html")); // displays the main page
});
